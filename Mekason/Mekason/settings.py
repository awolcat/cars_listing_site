"""
Django settings for Mekason project.
...
SECRET_KEY = 'django-insecure-cqsw(!bjbsdblc*8ttq_c9gpe53%k)l5gfa7u9!75h99^p9ot)'
...
ROOT_URLCONF = 'Mekason.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.jinja2.Jinja2',
        'DIRS': ['/cars_listing_site/Mekason/listing_site/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
